...
public static class Zoom
{
    ...
    public static void Postfix()
    {
        try
        {
            ...
            if (BanMod.EnableZoom.Value && Utils.IsShip && !Utils.IsMeeting && Utils.IsCanMove && PlayerControl.LocalPlayer.Data.IsDead || BanMod.EnableZoom.Value && Utils.IsLobby && Utils.IsCanMove)
            {
                ...
                switch (Input.mouseScrollDelta.y)
                {
                    ...
                    case < 0:
                    {
                        if (BanMod.EnableZoom.Value && Utils.IsDead || BanMod.EnableZoom.Value && Utils.IsFreePlay || BanMod.EnableZoom.Value && Utils.IsLobby)
                        {
