...
namespace BanMod
{
    ...
    public static class GameSettingMenuPatch
    {
        ...
        public static CategoryHeaderMasked SettingCategoryHeader { get; private set; }
        ...
        public static void StartPostfix(GameSettingMenu __instance)
        {
            ...
            // 各カテゴリの見出しを作成
            SettingCategoryHeader = CreateCategoryHeader(__instance, SettingsTab, "TabGroup.Setting");
    ...
    public class GameOptionsMenuUpdatePatch
    {
        ...
        public static void Postfix(GameOptionsMenu __instance)
        {
            ...
            UpdateCategoryHeader(GameSettingMenuPatch.SettingCategoryHeader, ref offset);
            foreach (var option in OptionItem.SettingOptions)
            {
