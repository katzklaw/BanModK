...
namespace BanMod
{
    ...
    public static class Options
    {
        ...
        public static void Load()
        {
            ...
            AktiveLobby = BooleanOptionItem.Create(1_000_097, "AktiveLobby", false, TabGroup.Setting, true);
            ...
            AddBanToList = BooleanOptionItem.Create(1_000_101, "AddBanToList", true, TabGroup.Banlist, true);
